...
namespace NoticiasAppMVC.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCategorias,Categoria1")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCategorias,Categoria1")] Categoria categoria)
        {
